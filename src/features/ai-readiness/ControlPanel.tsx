                                                            ...
                                                            <ul className="mt-4 space-y-2">
                                                                {check.actionItems.map(
                                                                    (item: string, i: number) => (
                                                                        ...
                                                                        >
                                                                            <span className="text-heat-100 mt-1">
                                                                                •
                                                                            </span>
                                                                            <span>{item}</span>
                                                                        </li>
                        ...
                        {aiInsights.length > 0 && (
                            ...
                            >
                                ...
                                <div className="mt-16 text-center">
                                    ...
                                    <div className="text-label-small text-heat-100 opacity-60">
                                        AI Score
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        >
                            <div className="inline-flex items-center gap-8 px-16 py-8 bg-heat-4 rounded-8">
                                <span className="text-label-medium text-accent-black">
                                    AI analysis found{" "}
                                    {aiInsights.filter((i) => i.score && i.score < 50).length}{" "}
                            ...
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    if (data.success && data.insights) {
                                        ...
                                        // Calculate enhanced score
                                        if (data.insights.length > 0) {
                                            const aiScores = data.insights.map(
                                                (i: any) => i.score || 0
                                            );
                                            const avgAiScore =
                                                aiScores.reduce(
