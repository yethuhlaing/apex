        ...
        <div className="overlay contain-layout pointer-events-none lg-max:hidden">
            ...
            <div className="cw-[1314px] z-[105] absolute top-0 border-x border-border-faint h-full">
                <div className="text-mono-x-small font-mono text-black-alpha-12 select-none">
                    <div className="absolute top-111 -left-1 w-102 text-center"> [ 200 OK ] </div>
                    <div className="absolute bottom-10 -left-1 w-102 text-center"> [ .JSON ] </div>

                    <div className="absolute top-111 -right-1 w-102 text-center"> [ SCRAPE ] </div>
                    <div className="absolute bottom-10 -right-1 w-102 text-center"> [ .MD ] </div>
                </div>
            ...
            <CurvyRect className="cw-[708px] absolute top-100 h-[calc(100%-99px)]" bottom />
            ...
            <div className="cw-[1112px] absolute top-0 h-full">
                ...
                <CurvyRect className="w-100 absolute top-full h-100 -left-99" topRight />
                <CurvyRect className="w-100 absolute top-full h-100 -right-99" topLeft />
                ...
                <CurvyRect className="size-102 absolute left-101 top-100" bottomLeft top />
                <CurvyRect className="size-102 absolute left-101 top-201" bottom topLeft />

                <CurvyRect className="size-102 absolute right-101 top-100" bottomRight top />
                <CurvyRect className="size-102 absolute right-101 top-201" bottom topRight />
                ...
                <CurvyRect className="size-102 absolute top-100 left-202" bottomRight top />
                ...
                <CurvyRect className="size-102 absolute top-100 right-202" bottomLeft top />
            </div>
        </div>
    );
}
