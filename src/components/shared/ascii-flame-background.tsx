...
export default function AsciiFlameBackground({
    ...
    return (
        <div ref={wrapperRef} className={cn("relative pointer-events-none select-none", className)}>
            <div
                ref={ref}
                className={cn("font-ascii absolute inset-0 fc-decoration", colorClassName)}
                style={{
                    whiteSpace: "pre",
