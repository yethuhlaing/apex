...
export default function CurvyRect({
    ...
    return (
        <div
            className={cn(className, "pointer-events-none contain-[layout,paint] curvy-rect")}
            {...props}
        >
            {hasTopLeft && <Curve className="-rotate-90 absolute top-0 left-0" />}
            {hasTopRight && <Curve className="absolute top-0 right-0" />}
            {hasBottomLeft && <Curve className="rotate-180 absolute bottom-0 left-0" />}
            {hasBottomRight && <Curve className="rotate-90 absolute bottom-0 right-0" />}
        </div>
    );
}

export const Connector = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg
            fill="none"
            height="21"
...
export const ConnectorToRight = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg
            fill="none"
            height="21"
...
export const ConnectorToLeft = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg
            fill="none"
            height="21"
...
export const ConnectorToTop = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg
            fill="none"
            height="11"
...
export const ConnectorToBottom = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg
            fill="none"
            height="11"
