    ...
    const trendColor =
        trend === "up"
            ...
            : trend === "down"
              ...
              : "text-black-alpha-64";
    const trendBg =
        trend === "up" ? "bg-green-50" : trend === "down" ? "bg-red-50" : "bg-black-alpha-4";
        ...
        >
            ...
            <div className="space-y-2">
                <div className="flex items-baseline gap-1">
                    {prefix && (
                        <span className="text-body-large text-black-alpha-64">{prefix}</span>
                    )}
                    <span className="text-h3 font-semibold text-accent-black">{value}</span>
                    {suffix && (
                        <span className="text-body-large text-black-alpha-64">{suffix}</span>
                    )}
                </div>
