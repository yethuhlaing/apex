        ...
        <div className={cn("w-full", className)}>
            {text && (
                <div className="mb-4 text-label-large text-black-alpha-56">
                    <ScrambleText text={text} delay={0} duration={1.2} isInView={isInView} />
                </div>
            )}
...
export const ShimmerSingle = ({ className, text }: { className?: string; text?: string }) => {
    const [isInView, setIsInView] = useState(false);
        ...
        <div className={cn("w-full h-full relative overflow-hidden", className)}>
            ...
            {text && (
                <div className="absolute top-4 left-4 text-label-small text-black-alpha-56 z-10">
                    <ScrambleText text={text} delay={0} duration={0.8} isInView={isInView} />
                </div>
            )}
