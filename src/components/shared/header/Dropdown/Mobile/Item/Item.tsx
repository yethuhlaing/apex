...
import { ConnectorToLeft, ConnectorToRight } from "@/components/shared/layout/curvy-rect";
import { NAV_ITEMS } from "@/components/shared/header/Nav/Nav";
import { cn } from "@/utils/cn";

export default function HeaderDropdownMobileItem({ item }: { item: (typeof NAV_ITEMS)[number] }) {
