        ...
        <div className="lg-max:max-w-[unset] container lg:flex gap-16">
            {navigationItems.map((item, index) => (
                <div className="flex-1" key={index}>
                    ...
                    {Array.from(
                        new Set(item.items.map((it) => it.sectionLabel).filter(Boolean) as string[])
                    ).map((section) => (
                        <div key={section}>
                    ...
                    <div className="h-42 border-t border-border-faint border-x -mt-1 relative lg-max:hidden">
                        <CurvyRect className="-top-1 absolute -left-1 w-[calc(100%+2px)]" top />
                        <CurvyRect
            ...
            <div className="flex-1 max-w-360 relative">
                ...
                <div className="h-42 border-t border-border-faint border-r -mt-1 relative lg-max:hidden">
                    <CurvyRect className="-top-1 absolute left-0 w-[calc(100%+1px)]" top />
                    <CurvyRect className="bottom-full absolute left-0 w-[calc(100%+1px)]" bottom />
                </div>
            </div>
        </div>
    );
