...
export default memo(function Spinner({
    ...
    return (
        <div {...attrs} className={cn("size-20 min-w-[20px] relative", attrs.className)}>
            <AnimatePresence initial={false}>{!finished && <Canvas />}</AnimatePresence>
...
const Canvas = memo(function Canvas() {
    ...
    useEffect(() => {
        ...
        const grid = [
            ...
            [1, 0.4, 0.4, 1, 0.4, 0.12, 0.12, 0.4, 0.4, 0.12, 0.12, 0.4, 1, 0.4, 0.4, 1],
            [
                0.4, 0.12, 0.12, 0.4, 0.12, 0.04, 0.04, 0.12, 0.12, 0.04, 0.04, 0.12, 0.4, 0.12,
                0.12, 0.4,
            ],
            [0.12, 0.04, 0.04, 0.12, 0.04, 0, 0, 0.04, 0.04, 0, 0, 0.04, 0.12, 0.04, 0.04, 0.12],
