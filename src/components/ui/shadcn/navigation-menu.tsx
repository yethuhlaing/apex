...
const NavigationMenu = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Root> & {
        viewportProps?: React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Viewport>;
    }
...
>(({ className, children, ...props }, ref) => (
    <NavigationMenuPrimitive.Trigger
        ref={ref}
        className={cn(navigationMenuTriggerStyle(), "group items-center", className)}
        {...props}
    >
        {children}
        {""}
