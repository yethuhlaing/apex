...
import HomeHeroBackground from "@/components/sections/hero/Background/Background";
import { BackgroundOuterPiece } from "@/components/sections/hero/Background/BackgroundOuterPiece";
import HomeHeroBadge from "@/components/sections/hero/Badge/Badge";
import HomeHeroPixi from "@/components/sections/hero/Pixi/Pixi";
import HomeHeroTitle from "@/components/sections/hero/Title/Title";
import HeroInputSubmitButton from "@/components/sections/hero-input/Button/Button";
        ...
        <HeaderProvider>
            <div className="min-h-screen bg-background-base">
                ...
                <section className="overflow-x-clip" id="home-hero">
                    <div
                        className={`pt-28 lg:pt-254 lg:-mt-100 pb-115 relative ${isAnalyzing || showResults ? "" : ""}`}
                        id="hero-content"
                    >
                        <HomeHeroPixi />
                        <HeroFlame />
